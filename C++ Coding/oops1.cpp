...
class student{
    ...
    int check=10;
    int marksheet(int m);
    void address(string name,string village,string city);
};

int student::marksheet(int m)
{
    return m+check;
}
void student::address(string name,string village,string city)
{
    cout<<name<<"\n";
    cout<<village<<"\n";
    cout<<city<<"\n";
    cout<<"this is the info of a particular student"<<"\n";
}
...
{
    student s;
    cout<<s.marksheet(1000)<<"\n";
    s.address("Ramesh","bahilwara","Muzaffarpur");
}
