...
void solve()
{
    ...
    list<list<int>>l1;
    int n=3;
    l1.push_back({1,2,3,4});    
    l1.push_back({1,2,3,4});    
    l1.push_back({11,21,13,41});    
    l1.push_back({11,21,13,41});    
    l1.push_back({11,21,13,41});    
    l1.push_back({111,21,13,41});    
    l1.push_back({11,211,13,41});    
    l1.push_back({11,21,123,41});    
    l1.push_back({11,21,13,431});    
    l1.push_back({11,271,13,41});    
